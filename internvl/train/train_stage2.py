...
class CustomTrainer(Trainer):
    ...
    def evaluate(self, eval_dataset=None,ignore_keys=None):
        ...
        with torch.no_grad():
            for id, item2 in enumerate(eval_dataloader):
                ...
                data_list.append([imgname, answer, decoded_output, mos_score, score1, level])
    ...
    def save_and_evaluate(self, data_list, output_file='results.csv', metrics_file='metrics.txt'):
        ...
        df = pd.DataFrame(data_list, columns=['imgname', 'answer', 'output', 'mos', 'pred_score','level'])
        ...
        # Print results
        print(f'SRCC_level: {srcc2}')
        print(f'PLCC_level: {plcc2}')
        print(f'KRCC_level: {krcc2}')
